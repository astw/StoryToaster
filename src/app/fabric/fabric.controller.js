...
angular.module('storyToaster')
  .controller('fabricTestController', function ($scope) {
    ...
    $scope.addText = function(){
      ...
      var txtBox3 = new fabric.IText("IText", {
        ...
        height: 60
        ,
        boxPath: '/assets/images/callout/callout/callout_circle_right/callout_circle_right.svg'
      });
      canvas.add(txtBox3);
     ...
     var  imageIText = new ImageIText ('hi ImageIText,',{
        ...
        width: 120,
        height: 20,
        src:'/assets/images/callout/callout_rounded_rectangle_right/callout_rounded_rectangle_right.svg'
     });
     canvas.add(imageIText);
      ...
      imageIText = new ImageTextbox ('hi ImageITextBox,',{
          ...
          width: 120,
          height: 60,
          src:'/assets/images/callout/callout_rectangle_right/callout_rectangle_right.svg'
        });
     canvas.add(imageIText);
    //
    ...
    //});
      ...
      imageIText = new fabric.BolloonTextbox ('hi BolloonTextbox ,',{
        ...
        width: 120,
        height: 60,
        boxPath:'/assets/images/callout/callout_rectangle_right/callout_rectangle_right.svg'
      });
      canvas.add(imageIText);
      ...
      if(current === 'color'){
        // chnage to image
         canvas.setBackgroundImage('/assets/test/img_1852.jpg', canvas.renderAll.bind(canvas));
          fabric.Image.fromURL('/assets/images/callout/callout_circle_right/callout_circle_right.svg',
            function(oImage){
              canvas.add(oImage);
            });
