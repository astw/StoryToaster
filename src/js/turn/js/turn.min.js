...
(function (f) {
    function J(a, b, c) {
        ...
        throw n(c[0] + " is not a method or property");
    }
    ...
    function S(a, b, c, d, e) {
        var h = 1 - e,
            k = h * h * h,
            f = e * e * e;
        return j(Math.round(k * a.x + 3 * e * h * h * b.x + 3 * e * e * h * c.x + f * d.x), Math.round(k * a.y + 3 * e * h * h * b.y + 3 * e * e * h * c.y + f * d.y))
    }
    ...
    function P(a, b, c, d, e) {
        var h, k = [];
        if ("-webkit-" == w) {
            for (h = 0; h < e; h++) k.push("color-stop(" + d[h][0] + ", " + d[h][1] + ")");
            a.css({
            ...
            var i = Math.atan2(h, f),
                ...
                o = Math.tan(i);
            h = -1 / o;
            o = (h * c.x - c.y - o * b.x + b.y) / (h - o);
            c = h * o - h * c.x + c.y;
            b = Math.sqrt(Math.pow(o - b.x, 2) + Math.pow(c - b.y, 2));
            for (h = 0; h < e; h++) k.push(" " + d[h][1] + " " + 100 *
                (b + f * d[h][0]) / g + "%");
            a.css({
                "background-image": w + "linear-gradient(" + -i + "rad," + k.join(",") + ")"
            })
        }
    }
    ...
    var y, w = "",
        ...
        W = {
            ...
            init: function (a) {
                ...
                e.eventHandlers = {
                    mouseStart: function () {
                        for (var a in e.pages)
                            if (l(a, e.pages) && !1 === i._eventStart.apply(e.pages[a], arguments)) return !1
                    },
                    mouseMove: function () {
                    ...
                    start: function () {
                        return g._start.apply(c, arguments)
                    }
                };
                if (a.when)
                    for (b in a.when) l(b, a.when) && this.bind(b, a.when[b]);
                this.css({
                    position: "relative",
                    width: a.width,
                    height: a.height
                ...
                y && (!s && a.acceleration) && this.transform(F(0, 0, !0));
                for (b = 0; b < h.length; b++) "1" != f(h[b]).attr("ignore") && this.turn("addPage", h[b], ++d);
                f(this).bind(q.down, e.eventHandlers.mouseStart).bind("end", g._end).bind("pressed", g._pressed).bind("released", g._released).bind("flip", g._flip);
            ...
            addPage: function (a, b) {
                ...
                if (b)
                    if (b == h) d = !0;
                        ...
                        if (b > h) throw n('Page "' + b + '" cannot be inserted');
                    } else b = h, d = !0;
                1 <= b && b <= h && (c = "double" == e.display ? b % 2 ? " odd" : " even" : "", e.done && this.turn("stop"), b in e.pageObjs && g._movePages.call(this, b, 1), d && (e.totalPages = h), e.pageObjs[b] = f(a).css({
                    "float": "left"
                }).addClass("page p" + b + c), g._addPage.call(this, b), g._removeFromDOM.call(this));
                return this
            },
            _addPage: function (a) {
                var b = this.data(),
            ...
            destroy: function () {
                ...
                if ("prevented" != r("destroying", this)) {
                    b.destroying = !0;
                    f.each(c, function (b, c) {
                        a.unbind(c)
                    });
                    this.parent().unbind("start", b.eventHandlers.start);
                    for (f(document).unbind(q.move, b.eventHandlers.mouseMove).unbind(q.up, b.eventHandlers.mouseEnd); 0 !==
            ...
            zoom: function (a) {
                var b = this.data();
                if ("number" == typeof a) {
                    if (0.0010 > a || 100 < a) throw n(a + " is not a value for zoom");
                    if ("prevented" == r("zooming", this, [a, b.zoom])) return this;
            ...
            range: function (a) {
                ...
                if (1 > a || a > e.totalPages) throw n('"' + a + '" is not a page for range');
                d[1] = d[1] || d[0];
            ...
            _removeFromDOM: function () {
                var a, b = this.data();
                for (a in b.pageWrap) l(a, b.pageWrap) && !g._necessPage.call(this, a) && g._removePageFromDOM.call(this, a)
            },
            ...
            removePage: function (a) {
                var b = this.data();
                if (1 > a || a > b.totalPages) throw n("The page " + a + " doesn't exist");
                b.pageObjs[a] && (this.turn("stop"), g._removePageFromDOM.call(this, a), delete b.pageObjs[a]);
                g._movePages.call(this, a, -1);
                b.totalPages -= 1;
                b.page > b.totalPages ? this.turn("page", b.totalPages) : g._makeRange.call(this);
                return this
            },
                ...
                var c, d = this,
                    ...
                    f = function (a) {
                        ...
                        e.pagePlace[a] && e.pageWrap[a] && (e.pagePlace[c] = c, e.pageWrap[c] = e.pageObjs[c].hasClass("fixed") ? e.pageWrap[a].attr("page", c) : e.pageWrap[a].css(g._pageSize.call(d, c, !0)).attr("page", c), e.pages[a] && (e.pages[c] = e.pages[a].flip("options", {
                            ...
                            delete e.pagePlace[a], delete e.pageZoom[a], delete e.pageObjs[a], delete e.pageWrap[a]))
                    };
                if (0 < b)
            ...
            display: function (a) {
                ...
                if (-1 == f.inArray(a, U)) throw n('"' + a + '" is not a value for display');
                switch (a) {
                case "single":
            ...
            direction: function (a) {
                ...
                a = a.toLowerCase();
                if (-1 == f.inArray(a, V)) throw n('"' + a + '" is not a value for direction');
            ...
            corner: function () {
                var a, b, c = this.data();
                for (b in c.pages)
                    if (l(b, c.pages) && (a = c.pages[b].flip("corner"))) return a;
                return !1
            },
            data: function () {
                return this.data()
            ...
            size: function (a, b) {
                ...
                for (c in e.pageWrap) l(c, e.pageWrap) && (d = g._pageSize.call(this, c, !0), e.pageObjs[c].css({
                    width: d.width,
                    height: d.height
            ...
            stop: function (a, b) {
                if (this.turn("animating")) {
                    ...
                    for (c = 0; c < h.pageMv.length; c++) h.pageMv[c] && h.pageMv[c] !== a && (e = h.pages[h.pageMv[c]], d = e.data().f.opts, e.flip("hideFoldedPage",
            ...
            _turnPage: function (a, b) {
                ...
                if (e.page != a) {
                    var j = e.page;
                    if ("prevented" == r("turning", this, [a, i])) {
                        j == e.page && -1 != f.inArray(h, e.pageMv) && e.pages[h].flip("hideFoldedPage", !0);
                        return
                    } - 1 != f.inArray(1, i) && this.trigger("first"); - 1 != f.inArray(e.totalPages, i) && this.trigger("last")
                }
                if (b) this.turn("stop", h);
                else {
                    g._missing.call(this, a);
                ...
                e.pages[c] && (h = e.pages[c].data().f,
                    k = h.opts, i = e.opts.turnCorners.split(","), e.tpage = d, k.next != d && (k.next = d, k.force = !0), this.turn("update"), "hard" == h.effect ? "ltr" == e.direction ? e.pages[c].flip("turnPage", a > c ? "r" : "l") : e.pages[c].flip("turnPage", a > c ? "l" : "r") : "ltr" == e.direction ? e.pages[c].flip("turnPage", i[a > c ? 1 : 0]) : e.pages[c].flip("turnPage", i[a > c ? 0 : 1]))
            },
            page: function (a) {
                var b = this.data();
                ...
                if (!b.disabled && !b.destroying) {
                    a = parseInt(a, 10);
                    if (0 < a && a <= b.totalPages) return a != b.page && (!b.done || -1 != f.inArray(a, this.turn("view")) ?
                        g._fitPage.call(this, a) : g._turnPage.call(this, a)), this;
            ...
            peel: function (a, b) {
                ...
                if (!1 === a) this.turn("stop", null, b);
                    ...
                    "ltr" == c.direction ? -1 != a.indexOf("l") ? d[0] : d[1] : -1 != a.indexOf("l") ? d[1] : d[0], c.pages[d]) c.pages[d].flip("peel", a, b);
                else throw n("Unexpected corner " + a);
                return this
            },
            ...
            _start: function (a, b, c) {
                var d = b.turn.data(),
                    e = d.pageZoom[b.page];
                a.isDefaultPrevented() || (e && e != d.zoom && (b.turn.trigger("zoomed", [b.page, b.turn.turn("view", b.page), e, d.zoom]), d.pageZoom[b.page] = d.zoom), "single" == d.display && c && ("l" == c.charAt(1) &&
                    "ltr" == d.direction || "r" == c.charAt(1) && "rtl" == d.direction ? (b.next = b.next < b.page ? b.next : b.page - 1, b.force = !0) : b.next = b.next > b.page ? b.next : b.page + 1), g._addMotionPage.call(a.target));
            ...
            _released: function (a, b) {
                ...
                if (200 > (new Date).getTime() - e.time || c) a.preventDefault(), g._turnPage.call(h, e.opts.next, !1 === i._cornerActivated.call(d, b, 1));
                k.mouseAction = !1
            },
            _flip: function (a) {
                a.stopPropagation();
            ...
            calculateZ: function (a) {
                ...
                for (b = 0; b <= g; b++) c = a[b], d = f.pages[c].data().f.opts.next, e = f.pagePlace[c], o(c), o(d), c = f.pagePlace[d] == d ? d : c, j.pageZ[c] = f.totalPages - Math.abs(i - c), j.partZ[e] = 2 * f.totalPages - g + b;
                return j
            },
            update: function () {
                var a, b = this.data();
                if (this.turn("animating") && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap)
                        if (l(a, b.pageWrap) && (c = b.pageObjs[a].hasClass("fixed"), b.pageWrap[a].css({
                            display: d.pageV[a] || c ? "" : "none",
                            zIndex: (b.pageObjs[a].hasClass("hard") ? d.partZ[a] : d.pageZ[a]) || (c ? -1 : 0)
                        }), c = b.pages[a])) c.flip("z", d.partZ[a] || null), d.pageV[a] && c.flip("resize"), b.tpage ? c.flip("hover", !1).flip("disable", -1 == f.inArray(parseInt(a, 10), b.pageMv) &&
                            a != i[0] && a != i[1]) : c.flip("hover", !1 === e).flip("disable", a != h[0] && a != h[1])
                } else
                    for (a in b.pageWrap) l(a, b.pageWrap) && (d = g._setPageLoc.call(this, a), b.pages[a] && b.pages[a].flip("disable", b.disabled || 1 != d).flip("hover", !0).flip("z", null));
                return this
            },
            _updateShadow: function () {
                ...
                for (var i = 0; i < c.pageMv.length && a[0] && a[1]; i++) a =
                    this.turn("view", c.pages[c.pageMv[i]].data().f.opts.next), b = this.turn("view", c.pageMv[i]), a[0] = a[0] && b[0], a[1] = a[1] && b[1];
            ...
            _setPageLoc: function (a) {
                var b = this.data(),
                    ...
                    d = 0;
                if (a == c[0] || a == c[1]) d = 1;
                else if ("single" == b.display && a == c[0] + 1 || "double" ==
                    b.display && a == c[0] - 2 || a == c[1] + 2) d = 2;
            ...
            options: function (a) {
                ...
                if (a.when)
                    for (var c in a.when) l(c, a.when) && this.unbind(c).bind(c, a.when[c]);
                return this
            },
            version: function () {
                return "4.1.0"
            ...
            _cAllowed: function () {
                var a = this.data().f,
                    ...
                    c = a.opts.turn.data(),
                    d = b % 2;
                return "hard" == a.effect ? "ltr" == c.direction ? [d ? "r" : "l"] : [d ? "l" : "r"] : "single" == c.display ? 1 == b ? "ltr" == c.direction ? t.forward : t.backward : b == c.totalPages ? "ltr" == c.direction ? t.backward : t.forward : t.all : "ltr" ==
                    c.direction ? t[d ? "forward" : "backward"] : t[d ? "backward" : "forward"]
            },
            _cornerActivated: function (a) {
                ...
                return -1 ==
                    f.inArray(a.corner, h) ? !1 : a
            },
            _isIArea: function (a) {
                var b = this.data().f.parent.offset(),
                    a = s && a.originalEvent ? a.originalEvent.touches[0] : a;
            ...
            _backGradient: function () {
                var a = this.data().f,
                    b = a.opts.turn.data();
                if ((b = b.opts.gradients && ("single" == b.display || 2 != a.opts.page &&
                    a.opts.page != b.totalPages - 1)) && !a.bshadow) a.bshadow = f("<div/>", p(0, 0, 1)).css({
                    position: "",
                    width: this.width(),
                    height: this.height()
                }).appendTo(a.parent);
            ...
            resize: function (a) {
                ...
                case "sheet":
                    a &&
                        (a = Math.round(Math.sqrt(Math.pow(d, 2) + Math.pow(e, 2))), b.wrapper.css({
                        width: a,
                        height: a
                    }), b.fwrapper.css({
                        width: a,
            ...
            _addPageWrapper: function () {
                ...
                case "hard":
                    ...
                    a.wrapper = f("<div/>", p(0, 0, 2)).css(d).appendTo(c).prepend(this);
                    a.fpage = f("<div/>", p(0, 0, 1)).css(d).appendTo(c);
                    b.opts.gradients && (a.ashadow = f("<div/>", p(0, 0, 0)).hide().appendTo(c), a.bshadow = f("<div/>", p(0, 0, 0)));
                    break;
                case "sheet":
                    var d = this.width(),
                        e = this.height();
                    ...
                    a.wrapper = f("<div/>", p(0, 0, this.css("z-index"))).appendTo(c).prepend(this);
                    a.fwrapper = f("<div/>", p(c.offset().top, c.offset().left)).hide().appendTo(a.fparent);
                    a.fpage = f("<div/>", p(0, 0, 0, "visible")).css({
                        cursor: "default"
                    }).appendTo(a.fwrapper);
                    b.opts.gradients && (a.ashadow = f("<div/>", p(0, 0, 1)).appendTo(a.fpage));
            ...
            _fold: function (a) {
                ...
                case "hard":
                    ...
                    case "l":
                        l = "0% 50%";
                        o = "100% 50%";
                        r ? (f = 0, g = 0 < b.opts.next - 1, u = 1) : (f = "100%", g = b.opts.page + 1 < p, u = 0);
                        break;
                    case "r":
                        l = "100% 50%", o = "0% 50%", q = -q, e = -e, r ? (f = 0, g = b.opts.next + 1 < p, u = 0) : (f = "-100%", g = 1 != b.opts.page, u = 1)
                    }
                    t[w + "perspective-origin"] = o;
                    b.wrapper.transform("rotateY(" + q + "deg)translate3d(0px, 0px, " + (this.attr("depth") || 0) + "px)", o);
                    b.fpage.transform("translateX(" + e + "px) rotateY(" + (180 + q) + "deg)", l);
                    b.parent.css(t);
                    r ? (z = -z + 1, b.wrapper.css({
                        zIndex: n + 1
                    }), b.fpage.css({
                        zIndex: n
                    })) : (z -= 1, b.wrapper.css({
                    ...
                    c.opts.gradients && (g ? b.ashadow.css({
                        ...
                        opacity: -z + 1
                    }), r ? b.bshadow.parent()[0] != b.wrapper[0] && b.bshadow.appendTo(b.wrapper) : b.bshadow.parent()[0] != b.fpage[0] && b.bshadow.appendTo(b.fpage), P(b.bshadow, j(100 * u, 0), j(100 * (-u + 1), 0), [
                        [0, "rgba(0,0,0,0.3)"],
                        [1, "rgba(0,0,0,0)"]
                    ], 2));
                    break;
                case "sheet":
                    ...
                    var O = c.opts.acceleration,
                        ...
                        I = function () {
                            ...
                            if (g > L && (b =
                                K - g, f = R - h / Math.sin(b), v = j(Math.round(f * Math.cos(b)), Math.round(f * Math.sin(b))), C && (v.x = -v.x), E)) v.y = -v.y;
                            y = Math.round(m.y / Math.tan(g) + m.x);
                            b = e - y;
                            f = b * Math.cos(2 * g);
                            k = b * Math.sin(2 * g);
                            Q = j(Math.round(C ? b - f : y + f), Math.round(E ? k : h - k));
                            if (c.opts.gradients && (x = b * Math.sin(g), b = i._c2.call(s, a.corner), b = Math.sqrt(Math.pow(b.x - a.x, 2) + Math.pow(b.y - a.y, 2)) / e, D = Math.sin(L * (1 < b ? 2 - b : b)), N = Math.min(b, 1), M = 100 < x ? (x - 100) / x : 0, A = j(100 * (x * Math.sin(g) / e), 100 * (x * Math.cos(g) / h)), i._backGradient.call(s) && (B = j(100 * (1.2 * x * Math.sin(g) /
                                e), 100 * (1.2 * x * Math.cos(g) / h)), C || (B.x = 100 - B.x), !E))) B.y = 100 - B.y;
                            m.x = Math.round(m.x);
                            m.y = Math.round(m.y);
                            return !0
                        };
                    f = function (a, d, f, g) {
                        var k = ["0", "auto"],
                            ...
                            d = {
                                ...
                                right: k[d[2]],
                                bottom: k[d[3]]
                            }, k = {}, m = 90 != g && -90 != g ? C ? -1 : 1 : 0,
                            l = f[0] + "% " + f[1] + "%";
                        s.css(d).transform(G(g) + F(a.x + m, a.y, O), l);
                        b.fpage.css(d).transform(G(g) + F(a.x + Q.x - v.x - e * f[0] / 100, a.y + Q.y - v.y - h * f[1] / 100, O) + G((180 / g - 2) * g), l);
                        b.wrapper.transform(F(-a.x + o - m, -a.y + u, O) + G(-g), l);
                        b.fwrapper.transform(F(-a.x +
                            v.x + o, -a.y + v.y + u, O) + G(-g), l);
                        ...
                        ], 3, 0), i._backGradient.call(s) && P(b.bshadow, j(C ? 0 : 100, E ? 0 : 100), j(B.x, B.y), [
                            [0.6, "rgba(0,0,0,0)"],
                ...
                if (e) {
                    if (!f || !e.point || e.point.corner != a.corner) {
                        var g = e.opts.turn.data().mouseAction,
                            f = !1;
                        if ("prevented" == r("start", this, [e.opts, "hover" == e.status ||
                            g ? a.corner : null
                        ])) return !1
                    }
                    if (c) {
            ...
            hide: function () {
                ...
                case "sheet":
                    0 === --a.fparent.data().flips && a.fparent.hide(), this.css({
                        ...
                        right: "auto",
                        bottom: "auto"
                    }).transform(""), a.wrapper.transform(""), a.fwrapper.hide(), a.bshadow &&
                        a.bshadow.hide(), c.transform("")
                }
                a.visible = !1;
                return this
            },
            ...
            _eventMove: function (a) {
                var b = this.data().f;
                if (!b.disabled)
                    if (a = s ? a.originalEvent.touches : [a], b.corner) {
            ...
            _eventEnd: function () {
                var a = this.data().f,
                    b = a.corner;
                !a.disabled && b && "prevented" != r("released", this, [a.point || b]) && i.hideFoldedPage.call(this, !0);
                a.corner = null
            },
            disable: function (a) {
                i.setData.call(this, {
            ...
            peel: function (a, b) {
                var c = this.data().f;
                if (a) {
                    if (-1 == f.inArray(a, i._cAllowed.call(this))) throw n("Corner " + a + " is not permitted");
        ...
        animatef: function (a) {
            ...
            if (a) {
                ...
                for (var c = [], d = a.to.length, e = !0, g = this, i = (new Date).getTime(), j = function () {
                        if (b.effect && e) {
                            for (var f = [], l = Math.min(a.duration, (new Date).getTime() - i), n = 0; n < d; n++) f.push(b.effect.easing(1, l, a.from[n], c[n], a.duration));
                            a.frame(d == 1 ? f[0] : f);
                            if (l == a.duration) {
                                delete b.effect;
                                g.data(b);
